"""
 Updating from RealtimeSTT

The AudioToText class in the provided code facilitates
...
ACCESS_KEY = "apO+9MGInhSQQ5O87eiKQTgrIhk8xTB8zVzz8B1J8YbBduxV/tOAVQ=="
...
class AudioToText:
    ...
    def __init__(self,
        ...
        log_format = 'Transcription: %(name)s - %(levelname)s - %(message)s'
        ...
        self.transcript_process = mp.Process(
            target=AudioToText._transcription_worker,
            args=(
        ...
        if self.use_microphone.value:
            ...
            self.reader_process = mp.Process(
                target=AudioToText._audio_data_worker,
                args=(
                    self.audio_queue,
                    self.sample_rate,
                    self.buffer_size,
